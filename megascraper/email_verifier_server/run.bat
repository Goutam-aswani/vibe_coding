@echo off
REM ============================================================================
REM Email Verifier API - Quick Start (Port 8002)
REM ============================================================================
...
echo.
echo ======================================================================
echo Starting Email Verifier API on http://localhost:8002
echo ======================================================================
echo.
...
"%~dp0..\.venv\Scripts\python.exe" -m uvicorn app.main:app --host 0.0.0.0 --port 8002 --reload
